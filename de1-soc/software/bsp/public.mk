...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../ip/bf_time_pcm/bf_time_pcm.sopcinfo
...
# Design Name 
# setting SOPC_NAME is bf_time_pcm
SOPC_NAME := bf_time_pcm
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4082280
SOPC_SYSID_FLAG += --sidp=0x4082280
ELF_PATCH_FLAG  += --sidp 0x4082280

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1542848838
SOPC_SYSID_FLAG += --timestamp=1542848838
ELF_PATCH_FLAG  += --timestamp 1542848838
