...
# ACDS 16.0 211 linux 2018.11.16.23:49:19
...
# ----------------------------------------
# If ALT_PLL_AUDIO is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 linux 2018.11.16.23:49:20
# ----------------------------------------
# initialize variables
TOP_LEVEL_NAME="ALT_PLL_AUDIO"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/opt/altera_lite/16.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ALT_PLL_AUDIO.vo"
fi
