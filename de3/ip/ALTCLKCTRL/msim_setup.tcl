...
# ----------------------------------------
# If ALTCLKCTRL is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 linux 2018.04.19.01:28:02
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/opt/altera_lite/16.0/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ALTCLKCTRL_altclkctrl_0.v" -work altclkctrl_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ALTCLKCTRL.v"                                           
}
